...
export default StyleSheet.create({
  HeaderContainer:{flexDirection: 'row',backgroundColor:Colors.Orange,height:60,borderBottomWidth:1,borderStyle:'dashed',borderBottomColor:'#25282b',width:windowWidth,justifyContent: 'center',alignItems: 'center'},
