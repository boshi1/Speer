...
TextContaienr:{width:windowWidth-scaledSize(90),paddingLeft:5,paddingTop:4,justifyContent:'center'},
Text:{color:Colors.Darkwhite,fontFamily:FontsNames.Regular,letterSpacing:0.7},
