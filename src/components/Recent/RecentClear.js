...
const styles = StyleSheet.create({
    container: {padding:scaledSize(4),flexDirection:'row',justifyContent:'center',alignItems:'center',backgroundColor:Colors.lightgray,borderRadius:5},
    Text:{fontSize:scaledSize(12),fontFamily:FontsNames.Light,color:Colors.Darkwhite}
  });
